...
## First, the tool vocabulary

::: {.section-intro}
The template assumes tools, but users should not need to know them before the talk starts.
:::
...
## The repository gives the workflow a map

::: {.section-intro}
Once the tools are named, the folder structure tells them where to act.
:::
...
## A project starts with a few decisions

::: {.section-intro}
Before adding analysis, set identity, data rules, software expectations, and run order.
:::
