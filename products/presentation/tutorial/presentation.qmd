...
## READy is the workflow target {.fig-slide}
...
## The template is a practical answer {.fig-slide}
...
## Each tool has one main job {.fig-slide}
...
## The main path is data to products {.fig-slide}
...
## `code/` follows the analysis stages {.fig-slide}
...
## The example workflow runs in pieces {.fig-slide}
...
## AI belongs inside the review loop {.fig-slide}
