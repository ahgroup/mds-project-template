...
::: {.outline-list}
<div><span>1</span><strong>Why the template exists</strong><br>Motivation, ORDERly workflows, and AI responsibility.</div>
...
::: {.notes}
This section motivates the template before introducing folders or tools. The point is to make the audience care about project drift, ORDERly workflows, and human responsibility in AI-assisted analysis.
...
::: {.notes}
Documentation is essential for practical reproducibility. Running code is not enough if a collaborator cannot understand the project. The template therefore includes project-level and folder-level readmes plus usage instructions.
...
[Sources] Local template: readme.md; agents.md.
:::
...
<div class="section-subtitle">Orient, ask, review, run and check, then record.</div>

::: {.notes}
This section shifts from general project setup to AI operating practice. The audience should leave with a concrete loop for orienting, asking, reviewing, running and checking, and recording meaningful AI help.
...
## AI belongs inside an ORDERly loop
...
::: {.notes}
Use the loop to make AI work operational. First orient to the goal and inspect the relevant files. Ask for a bounded task with context and limits. Review the proposal. Run the affected code and inspect the actual output. Record meaningful assistance and the human decision. For real projects, the AI-use log provides transparency unless the project owner disables it.
...
[Sources] Local template: readme.md; new-project-instructions.md.
:::

## Sharing needs ORDERly structure
...
::: {.notes}
Sharing and reproducibility are related but not identical. A repository can be public and still be impossible to understand or rerun. ORDERly structure makes sharing useful by preserving organization, history, documentation, executable instructions, and a testable result.
...
:::: {.resource-grid}
::: {.resource}
**MDS project template**

<https://github.com/andreashandel/mds-project-template>
:::
::: {.resource}
...
[Sources] MDS project template: https://github.com/andreashandel/mds-project-template. MDS tools site: https://andreashandel.github.io/mds-tools/. Local template docs listed on slide.
:::
