...
The root-level file `../USAGE.md` explains what the example code files do and
the order in which to run them. Keep that file current as scripts are added,
...
If scripts need to be run in a specific order, document this in `../USAGE.md`
and, where useful, in comments in the scripts themselves.
