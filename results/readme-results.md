...
everything first. There are two main exceptions:
...
- large generated files that are too big for ordinary Git/GitHub use should go
  ...
  such as Git LFS;
- outputs that contain sensitive, private, regulated, identifiable, or otherwise
  restricted information should not be committed unless the project owner has
